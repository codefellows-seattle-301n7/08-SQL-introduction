...
const conString = 'postgres://tom:myPassword@localhost:5432/blog';
...
// Creates the articles database if it does not already exist. Then loadArticles() is being called to load the raw data.
loadDB();
